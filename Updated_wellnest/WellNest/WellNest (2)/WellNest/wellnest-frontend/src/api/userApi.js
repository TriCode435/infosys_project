...
// Fixed: Using 'api' instead of 'axios' to include tokens
...
// Fixed: Changed 'axios' to 'api' and used backticks for URL
export const likeBlogPost = (postId) => 
  api.patch(`/api/blog/${postId}/like`);

// Fixed: Changed 'axios' to 'api'
export const addBlogComment = (postId, content) => 
  api.post(`/api/blog/${postId}/comment`, { content });

// Pending posts (Only for Admin/Trainer)
export const getPendingBlogPosts = () => 
  api.get("/api/blog/pending");

// Status update (Approve/Reject)
export const updateBlogPostStatus = (postId, status) => 
  api.patch(`/api/blog/${postId}/status`, { status });