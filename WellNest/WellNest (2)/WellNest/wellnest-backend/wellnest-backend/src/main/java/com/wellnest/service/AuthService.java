...
public class AuthService {
    ...
    public LoginResponse login(LoginRequest loginRequest) {
        ...
        com.wellnest.entity.RefreshToken refreshToken = refreshTokenService.createRefreshToken(user.getId());

        return new LoginResponse(jwt, refreshToken.getToken(), user.getId(), user.getUsername(), user.getRole());
    }
    ...
    public java.util.Optional<com.wellnest.entity.RefreshToken> findByToken(String token) {
        return refreshTokenService.findByToken(token);
    }

    public com.wellnest.entity.RefreshToken verifyExpiration(com.wellnest.entity.RefreshToken token) {
